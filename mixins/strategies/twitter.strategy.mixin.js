  ...
  methods: {
    ...
    registerTwitterStrategy (setting, route) {
      ...
      try {
        ...
        this.logger.error('The \'passport-twitter\' package is missing. Please install it with \'npm i passport-twitter\' command.');
        return;
      }
      ...
      route.aliases[`GET /${providerName}`] = (req, res) => passport.authenticate(providerName, {})(req, res, callback(req, res));
      route.aliases[`GET /${providerName}/callback`] = (req, res) => passport.authenticate(providerName)(req, res, callback(req, res));
    },
